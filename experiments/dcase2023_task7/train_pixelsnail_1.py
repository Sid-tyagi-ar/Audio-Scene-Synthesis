    ...
    for i, (bottom, class_id, salience, file_name) in enumerate(loader):
        ...
        # print(key)
            for item in class_id:
                if key in item:
                    class_id_list.append(clas_dict[key])
                #   break  # Stop searching in class_id once a match is found
        # print class_id
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default= r'checkpoint\pixelsnail-final\bottom_074.pt')
