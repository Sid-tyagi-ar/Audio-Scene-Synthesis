...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--vqvae_checkpoint', type=str, default='./vqvae_046.pt'
    )
    parser.add_argument(
        '--pixelsnail_checkpoint',
        type=str,
        default='./checkpoint/pixelsnail-final/bottom_074.pt',
    )
    parser.add_argument(
        '--number_of_synthesized_sound_per_class', type=int, default=10
    )
